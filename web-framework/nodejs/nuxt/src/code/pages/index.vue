    ...
    <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
      ...
      <div class="mt-8 bg-white overflow-hidden shadow sm:rounded-lg p-6">
        ...
        <p class="mt-3 text-gray-600">
          <a
            style="color: #00b7ff"
            href="http://www.serverless-devs.com/zh-cn/index.html"
            target="_blank"
            >Serverless Devs</a
          >
          是一个开源开放的 Serverless
          开发者平台，致力于为开发者提供强大的工具链体系。通过该平台，开发者可以一键体验多云
          Serverless 产品，极速部署 Serverless 项目。<br />
        </p>
      ...
      <div style="padding: 20px; font: 14px">
        <div>
          <h3 style="font-weight: 500; margin: 16px 0 8px 0">
            步骤一. 准备工作
          </h3>
          <p style="color: #777">
            具体步骤请参照
            <a
              style="color: #00b7ff"
              href="http://www.serverless-devs.com/zh-cn/docs/installed/cliinstall.html"
            >
              Serverless Cli 安装</a
            >
          </p>
          ...
          <pre style="color: #777; background-color: #f0f0f0; padding: 8px">
s init start-nuxt-cap</pre
          >
          <h3 style="font-weight: 500; margin: 16px 0 8px 0">
            步骤三. 一键部署
          </h3>
          <p style="color: #777">进入到项目目录，在命令行执行</p>
          <pre
            style="
              color: #777;
              border: #eee;
...
s deploy</pre
          >
          <h2 style="font-weight: 500; margin: 16px 0 8px 0">帮助文档</h2>
      ...
      <div class="flex justify-center pt-4 space-x-2">
        <a
          href="https://github.com/devsapp/start-web-framework/tree/master/nuxt-ssr-app/src"
          target="_blank"
          ><svg
